...
/* LoRaWAN NwkSKey, network session key
   ...
   network initially.
   ttn*/
static const PROGMEM u1_t NWKSKEY[16] = { 0x9F, 0xCB, 0x80, 0x08, 0x0F, 0x82, 0x89, 0x88, 0xAE, 0x56, 0xDF, 0xDB, 0x99, 0xC0, 0x30, 0x70 };

/* LoRaWAN AppSKey, application session key
   This is the default Semtech key, which is used by the prototype TTN
   network initially.
   ttn*/
static const u1_t PROGMEM APPSKEY[16] = { 0xE8, 0xF2, 0x31, 0x96, 0x1A, 0x91, 0x22, 0xA5, 0x14, 0x76, 0x73, 0x5F, 0xAD, 0x84, 0xFF, 0xA7 };

/*
 LoRaWAN end-device address (DevAddr)
 See http://thethingsnetwork.org/wiki/AddressSpace
 ttn*/
static const u4_t DEVADDR = 0x2602160F;
...
void setup() {
    ...
    Serial.begin(9600);
     ss.begin(9600);  
    //while(!Serial);
    Serial.println("LoRa GPS Sheild TTN Example ");
